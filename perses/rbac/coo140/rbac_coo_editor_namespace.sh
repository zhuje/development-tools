...
#perse clusterRoleBindings
oc apply -f - <<EOF
kind: ClusterRoleBinding
apiVersion: rbac.authorization.k8s.io/v1
metadata:
  name: user1-persesglobaldatasource-editor
subjects:
  - kind: User
    apiGroup: rbac.authorization.k8s.io
    name: user1
roleRef:
  apiGroup: rbac.authorization.k8s.io
  kind: ClusterRole
  name: user1-persesglobaldatasource-editor-role
EOF
...
apiVersion: rbac.authorization.k8s.io/v1
metadata:
  name: user2-persesglobaldatasource-editor
subjects:
  - kind: User
    apiGroup: rbac.authorization.k8s.io
    name: user2
roleRef:
  apiGroup: rbac.authorization.k8s.io
  kind: ClusterRole
  name: user2-persesglobaldatasource-editor-role
EOF
...
apiVersion: rbac.authorization.k8s.io/v1
metadata:
  name: user1-editor-dashboard-coo
...
apiVersion: rbac.authorization.k8s.io/v1
metadata:
  name: user1-editor-dashboard-observ-test
...
apiVersion: rbac.authorization.k8s.io/v1
metadata:
  name: user2-editor-dashboard-perses-dev
...
apiVersion: rbac.authorization.k8s.io/v1
metadata:
  name: user1-editor-datasource-coo
  namespace: openshift-cluster-observability-operator
subjects:
  - kind: User
    apiGroup: rbac.authorization.k8s.io
...
apiVersion: rbac.authorization.k8s.io/v1
metadata:
  name: user1-editor-datasource-observ-test
  namespace: observ-test
subjects:
  - kind: User
    apiGroup: rbac.authorization.k8s.io
...
apiVersion: rbac.authorization.k8s.io/v1
metadata:
  name: user2-editor-datasource-perses-dev
  namespace: perses-dev
subjects:
  - kind: User
    apiGroup: rbac.authorization.k8s.io
